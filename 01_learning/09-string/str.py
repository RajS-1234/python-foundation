...
print(s1[0],type(s1[0]),id(s1[0])) # M <class 'str'> 
print(s1[1],type(s1[1]),id(s1[1])) # y <class 'str'>   
...
#5) Slicing
print(s1[1:5:2]) # strObject[beg:end:step]
...
print("H" in a) # True
print('abc'>'aba') # True
print('abc'<='Aba') # False , comparison based on ASCII value of characters
...
# Converts all characters to lowercase. It is similar to lower() method but more aggressive.
print("python programming".casefold()) # python programming
...
# It works like split(), but when you provide maxsplit, it starts splitting from the right side.
